...
The repository root also contains `MatrixDrive_RevB_KiCad_Project.zip`, a
standalone copy of the schematic, board, symbol library, BOM and connection
authorities.
...
- KiCad 8 or later for schematic conversion, PCB editing, ERC and DRC.
